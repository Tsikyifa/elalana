...
export default function MarcheActions({ onEdit, onDelete, canDelete = true, ariaLabel }: Props) {
        ...
        <>
          ...
          >
            <button
              ...
              onMouseDown={(e) => e.stopPropagation()}
              onClick={(e) => { e.stopPropagation(); e.preventDefault(); run(onEdit) }}
            >
            ...
            {canDelete && (
              <>
                ...
                <button
                  ...
                  onMouseDown={(e) => e.stopPropagation()}
                  onClick={(e) => { e.stopPropagation(); e.preventDefault(); run(onDelete) }}
                >
