...
type ConventionProgrammeRowActionsProps = {
  item: ConventionProgrammeItem
  onEdit: (item: ConventionProgrammeItem) => void
...
export function ConventionProgrammeRowActions({ item, onEdit, onDelete }: ConventionProgrammeRowActionsProps) {
  ...
  return (
    <>
      <button
        ...
        aria-label={`Actions — ${item.section}`}
        title="Actions"
        ...
        <>
          ...
          >
            <button
              ...
              onMouseDown={(e) => e.stopPropagation()}
              onClick={(e) => { e.stopPropagation(); e.preventDefault(); run(() => onEdit(item)) }}
            >
            ...
            <button
              ...
              onMouseDown={(e) => e.stopPropagation()}
              onClick={(e) => { e.stopPropagation(); e.preventDefault(); run(() => onDelete(String(item.id))) }}
            >
...
export default ConventionProgrammeRowActions
